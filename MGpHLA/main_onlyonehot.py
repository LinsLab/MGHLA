...
from Loader_only_onehot import train_predict_div_pep_new_blousm_onlyonehot_weight
#from model.main_model import MGHLA
from model.ablation_models import MGHLA_onlyonehot
from model.gvp_gnn import StructureEncoder
from data_transform import transform_data, CATHDataset
from pytorchtools import EarlyStopping
#from train_test_new_B07_onlyonehot import collate, train, predicting, eval_step
...
if __name__ == '__main__':
    ...
    epoch_save_dir = os.path.join(models_dir, 'MGHLA_onlyonehot_epoch_4')
    os.makedirs(epoch_save_dir, exist_ok=True)

    save_file = os.path.join(results_dir, 'MGHLA_onlyonehot_epoch_result_{:.0e}_{}_4'.format(LR, TRAIN_BATCH_SIZE))
    ...
    for seed in seeds:
        for fold in range(5):
            ...
            train_data, dev_data = train_predict_div_pep_new_blousm_onlyonehot_weight(train_file, valid_file, dataset_structure, seed)
            ...
            for epoch in range(NUM_EPOCHS):
                ...
                # Save the model
                path_saver = os.path.join(epoch_save_dir, 'MGHLA_onlyonehot_model_fold{}_epoch{}.pkl'.format(fold, epoch))
            ...
            best_model_path = os.path.join(epoch_save_dir, 'MGHLA_onlyonehot_model_fold{}_epoch{}.pkl'.format(fold, ep_best))
